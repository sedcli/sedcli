...
class TestSedcliHelp(unittest.TestCase):
	...
	def test_version(self):
		...
		"""
		cp = subprocess.run(["git", "describe"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
		sedcli_version = cp.stdout.strip()

		for good in [["--version"], ["-V"]]:
			...
			self.assertEqual(cp.stdout.strip(), b'sedcli %b' % (sedcli_version),
